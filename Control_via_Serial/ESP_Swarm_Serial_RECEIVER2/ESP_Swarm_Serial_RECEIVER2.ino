...
void OnDataRecv(const esp_now_recv_info_t *info, const uint8_t *incomingData, int len) {
  ...
  waveformType = constrain(myData.o, 1, 4);  
  
  targetFreq[0] = myData.i;
  targetFreq[1] = myData.j;
  targetFreq[2] = myData.k;

  targetVolume[0] = (float)myData.l / 255.0 / NUM_OSC;
  targetVolume[1] = (float)myData.m / 255.0 / NUM_OSC;
  targetVolume[2] = (float)myData.n / 255.0 / NUM_OSC;

  targetVolNoise = (float)myData.p / 255.0;  
